...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-blue-700 text-white hover:bg-blue-800 shadow-md shadow-blue-900/15",
        ghost:
          "hover:bg-slate-100 hover:text-foreground text-muted-foreground",
        outline:
          "border border-slate-200 bg-white text-foreground hover:bg-slate-50 hover:border-slate-300",
        secondary:
